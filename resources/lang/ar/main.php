...
return [
    ...
    'vaults' => 'الخزنه',
    'finance' => 'الحسابات',
    'wallet_does_not_have_enough_amount' => 'المحفظة لا يوجد بها رصيد كافى',
    'extra_expense' => 'مصروف إضافى',
    'booking_no' => 'رقم الطلب',
    'branch'        => 'فرع',
    'not_found'     => 'غير متوفر',
    'delivery_policies' => 'بوليصة التوصيل',
    'reports'       => 'التقارير',
    'report'        => 'التقرير',
    'settings'      => 'الاعدادات',
    "agent_assignment" => "تعيينات المندوبين",
    'bookings'      => 'طلبات النقل',
    'booking'       => 'طلب نقل',
    'staticPages'   => 'الصفحات الثابتة',
    'ourServices'   => 'خدماتنا',
    'transfer' => 'تحويل',
    'bank_tranferd' => 'البنك المحول اليه',
    'bank_wallet_does_not_have_enough_amount' => 'رصيد البنك لا يكفى',
