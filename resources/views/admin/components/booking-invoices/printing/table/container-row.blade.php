    ...
    <td style="padding: 4px 6px; text-align: start; border-right: 1px solid #e9ecef; vertical-align: top;">
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 4px;">
            <div style="display: flex; align-items: center; gap: 3px;">
                ...
                <span style="color: #212529; font-size: 10px; font-weight: 600;">{{ $booking_container->container_no ?? '' }}</span>
            </div>
            <div style="display: flex; align-items: center; gap: 3px;">
                <span style="font-weight: 700; color: #6c757d; font-size: 9px; min-width: 60px;">📏 مقاس ونوع:</span>
                <span style="color: #212529; font-size: 10px;">{{ $booking_container->container->full_name ?? '' }}</span>
            </div>
            <div style="display: flex; align-items: center; gap: 3px;">
                <span style="font-weight: 700; color: #6c757d; font-size: 9px; min-width: 60px;">📅 تاريخ:</span>
                <span style="color: #212529; font-size: 10px;">{{ $booking_container->arrival_date ?? '' }}</span>
            </div>
        </div>
