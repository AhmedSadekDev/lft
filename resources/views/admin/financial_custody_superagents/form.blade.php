        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group">
                    {!! Form::label("input_service_categories", __('admin.superagents'), ["class" => "required-field"]) !!}
                    {!! Form::select('superagent_id' , $superagents, old('superagent_id') , ["class" => "form-control selectpicker", "id" => "superagents", "placeholder"=> __('admin.superagents'),"data-live-search" => "true"]) !!}
                    @error('superagent_id')
