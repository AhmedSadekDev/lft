        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap  align-items-center py-5">
                ...
                <div class="">
                    ...
                    <a href="{{ route('shipments.export', ['id' => $car->id, 'ids' => implode(',', $shipments->pluck('id')->toArray())]) }}" class="btn btn-secondary">
                    ...
                    <tbody>
                        @foreach ($shipments as $shipment)
                            <tr>
                                ...
                                <td>
                                    {{ $shipment->booking_containers->first()->container_no }}
                                </td>
                                <td>
                                    {{ $shipment->money_transfer->value }}
                                </td>
                                <td>
                                    {{ $shipment->created_at }}
                                </td>
                                <td>
                                    @if($shipment->image)
                                    <a href="{{ asset($shipment->image->image) }}" download>
                                        <img src="{{ asset($shipment->image->image) }}" style="max-width:50px;">
                                    </a>
                                    @endif
                                </td>
