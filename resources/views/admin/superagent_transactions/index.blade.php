    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5 d-flex justify-content-between align-items-center">
            <div class="card-toolbar d-flex gap-2">
                <a href="{{ route('superagent_transactions.create', $superagent->id) }}" class="btn btn-primary font-weight-bolder">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('superagent_transactions.index', $superagent->id) }}" method="get">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 80px;">
                                @if($transaction->image)
                                    ...
                                    @endphp
                                    <a href="{{ $imagePath }}"
                                       data-lightbox="transaction-{{ $transaction->id }}"
                            ...
                            <td class="text-center">
                                <strong class="text-danger">{{ number_format($transaction->amount ?? 0, 2) }} جنيه</strong>
                            </td>
                            <td class="text-center">{{ $transaction->created_at ?? '-' }}</td>
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    <a class="btn btn-sm btn-clean btn-icon btn-icon-md" title="حذف" onclick="Delete({{ $transaction->id }})">
