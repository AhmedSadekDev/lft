...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 class="title">تعيين كلمة المرور للشركة</h1>
        </div>

        <p class="greeting">مرحباً ' . $nameEsc . '</p>

        <p class="text">
            تم إنشاء حساب لشركتكم على نظام ليدر، برجاء الضغط على الزر التالي لتعيين كلمة المرور الخاصة بكم وإكمال تفعيل الحساب.
        </p>
