...
class AssignAgentPasswordNotification extends Notification
{
    ...
    public function toPhpMail($notifiable)
    {
        ...
        $to = $this->agent->email ?? $notifiable->email ?? null;
...
<body>
    <div class="container">
        ...
        <p class="text">
            تم إنشاء حساب لك كوكيل على نظام ليدر، برجاء الضغط على الزر التالي لتعيين كلمة المرور الخاصة بك وإكمال تفعيل الحساب.
        </p>
