...
<div class="container">
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            ...
            <div class="mt-3">
                <?php if($allExpenses->first()): ?>
                <a href="<?php echo e(route('bookings.show', $allExpenses->first()->bookingContainer->booking_id)); ?>" class="btn btn-secondary float-right">
            ...
            <table class="table table-responsive-xl" id="table">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <td><?php echo e($allExpense->agent->name ?? ""); ?></td>
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/bookings/booking-containers/expenses.blade.php ENDPATH**/ ?>