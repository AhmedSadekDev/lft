                        ...
                        <div class="card-body text-white">
                            <div class="row text-center">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="font-weight-bold" style="font-size: 18px;"><?php echo e($carsWithDebts?->count() ?? 0); ?></div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
                ...
                <table class="table table-bordered table-hover" style="font-size: 14px;">
                    ...
                    <tbody>
                        ...
                        <tr style="transition: all 0.3s ease;">
                            ...
                            <td class="text-center align-middle">
                                <span class="text-dark"><?php echo e(number_format($car['total_cost'], 2)); ?> ج.م</span>
                            </td>
                            <td class="text-center align-middle">
                                <span class="text-success font-weight-bold"><?php echo e(number_format($car['total_paid'], 2)); ?> ج.م</span>
                            </td>
                            <td class="text-center align-middle">
                                <span class="badge badge-danger badge-pill" style="font-size: 13px; padding: 6px 12px;">
                                    <?php echo e(number_format($car['balance'], 2)); ?> ج.م
                                </span>
                            </td>
                            <td class="text-center align-middle">
                                <a href="<?php echo e(route('accounts.car.statement', $car['id'])); ?>?from=<?php echo e(\Carbon\Carbon::parse($reportDate)->startOfYear()->format('Y-m-d')); ?>&to=<?php echo e($reportDate); ?>"
                        ...
                        <tr style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-top: 3px solid #DC143C;">
                            ...
                            <td class="text-center align-middle">
                                <span class="text-success font-weight-bold" style="font-size: 15px;">
                                    <?php echo e(number_format($carsWithDebts->sum('total_paid'), 2)); ?> ج.م
                                </span>
                            </td>
                            <td class="text-center align-middle">
