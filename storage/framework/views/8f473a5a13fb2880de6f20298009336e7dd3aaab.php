        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">
                    <?php echo e(__('admin.drag_and_drop')); ?>
            ...
            <div class="modal-body">
                <form style="display:flex;align-items :center ; gap :20px" action="<?php echo e($import_route); ?>"
            ...
            <div class="modal-footer" style="justify-content: space-between !important;">
                <a download="/company_services_sample.xlsx" type="button" class="btn btn-warning" href="<?php echo e(asset('/storage/samples/company_services_sample.xlsx')); ?>"> <i class="bi bi-download"></i>
                    <i class="fas fa-download"></i>
                    <?php echo e(__('admin.sample')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/companyServices/modals/import.blade.php ENDPATH**/ ?>