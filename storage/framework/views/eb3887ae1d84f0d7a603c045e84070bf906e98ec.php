...
<?php elseif($method == 'PUT'): ?>
    <?php echo Form::model($city, ['url' => [$action], 'method'=>$method , 'enctype'=>'multipart/form-data', 'files' => true]); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group">
                    ...
                    <?php echo Form::text('title[en]' , (isset($city) ? $city->getTranslations('title')['en'] : old('title[en]')) , ["class" => "form-control", "id" => "input_title", "placeholder"=> __('admin.en_title')]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group">
                    ...
                    <?php echo Form::text('title[ar]' , (isset($city) ? $city->getTranslations('title')['ar'] : old('title[ar]')), ["class" => "form-control", "id" => "input_title", "placeholder"=> __('admin.ar_title')]); ?>
...
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/cities/form.blade.php ENDPATH**/ ?>