...
<div class="invoice-page-header mb-4" style="direction: rtl;">
    <div class="invoice-page-header-inner">
        <div class="d-flex align-items-center">
            ...
            <div class="mr-3">
                <h1 class="invoice-page-title"><?php echo e(__('admin.add_new_invoice')); ?></h1>
                <p class="invoice-page-subtitle"><?php echo e(__('admin.company_name')); ?>: <?php echo e($booking->company->name ?? '-'); ?></p>
            </div>
        </div>
        <a href="<?php echo e(route('bookings.show', $booking)); ?>" class="invoice-back-btn">
...
<div class="invoice-section-card mb-4">
    <div class="invoice-section-head invoice-section-head--blue">
        ...
        <h2 class="invoice-section-title"><?php echo e(__('admin.general_details')); ?></h2>
    </div>
            ...
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="invoice-info-item">
                    ...
                    <div class="invoice-info-text">
                        <span class="invoice-info-label"><?php echo e(__('admin.booking_number')); ?></span>
                        <span class="invoice-info-value"><?php echo e($booking->booking_number ?? '-'); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="invoice-info-item">
                    ...
                    <div class="invoice-info-text">
                        <span class="invoice-info-label"><?php echo e(__('admin.invoice_number')); ?></span>
                        <span class="invoice-info-value"><?php echo e((isset($invoice) ? $invoice->invoice_number : $invoice_number) ?? '-'); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="invoice-info-item">
                    ...
                    <div class="invoice-info-text">
                        <span class="invoice-info-label"><?php echo e(__('admin.company_name')); ?></span>
                        <span class="invoice-info-value"><?php echo e($booking->company->name ?? '-'); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="invoice-info-item">
                    ...
                    <div class="invoice-info-text">
                        <span class="invoice-info-label"><?php echo e(__('admin.certificate_number')); ?></span>
                        <span class="invoice-info-value"><?php echo e($booking->certificate_number ?? '-'); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="invoice-info-item">
                    ...
                    <div class="invoice-info-text">
                        <span class="invoice-info-label"><?php echo e(__('admin.arrival_date')); ?></span>
                        <span class="invoice-info-value"><?php echo e($booking->arrival_date ?? '-'); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-3">
                <div class="invoice-info-item">
                    ...
                    <div class="invoice-info-text">
                        <span class="invoice-info-label"><?php echo e(__('admin.shipping_agent')); ?></span>
                        <span class="invoice-info-value"><?php echo e($booking->shippingAgent?->title ?? '-'); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="invoice-section-card mb-4">
    <div class="invoice-section-head invoice-section-head--green">
        ...
        <h2 class="invoice-section-title"><?php echo e(__('admin.bill_type_invoice')); ?></h2>
    </div>
    <div class="invoice-section-body">
        <div class="invoice-subsection mb-4">
            <h3 class="invoice-subsection-title">
                ...
                <?php echo e(__('admin.transportation_details')); ?>
        ...
        <div class="invoice-subsection">
            <h3 class="invoice-subsection-title">
                ...
                <?php echo e(__('admin.taxed_services')); ?>

            </h3>
            <div class="table-responsive rounded border invoice-table-wrap">
                <?php echo $__env->make('admin.components.booking-services.table', ['booking_services' => $booking->taxed_services], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
</div>
...
<div class="invoice-section-card mb-4">
    <div class="invoice-section-head invoice-section-head--orange">
        ...
        <h2 class="invoice-section-title"><?php echo e(__('admin.attachments')); ?></h2>
    </div>
    <div class="invoice-section-body">
        <h3 class="invoice-subsection-title">
            <span class="invoice-subsection-icon invoice-subsection-icon--orange"><i class="fas fa-tags"></i></span>
            <?php echo e(__('admin.untaxed_services')); ?>

        </h3>
        <div class="table-responsive rounded border invoice-table-wrap">
            <?php echo $__env->make('admin.components.booking-services.table', ['booking_services' => $booking->untaxed_services, 'expensesServices' => $booking->expenses], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
...
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/components/booking-invoices/listings.blade.php ENDPATH**/ ?>