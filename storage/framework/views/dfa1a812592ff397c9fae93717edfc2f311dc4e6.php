        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-toolbar">
                    ...
                    <?php if(auth()->user()->hasPermissionTo('permissions.create')): ?>
                        <a href="<?php echo e(route('permissions.create')); ?>" class="btn btn-primary font-weight-bolder">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($role->name != 'Admin'): ?>
                                        <?php if(auth()->user()->hasPermissionTo('permissions.update')): ?>
                                        ...
                                        <?php if(auth()->user()->hasPermissionTo('permissions.delete')): ?>
                                            <button class="btn btn-icon btn-light btn-hover-danger btn-sm delete"
                                                onclick="Delete('<?php echo e($role->id); ?>')">
        ...
        function Delete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = '<?php echo e(route('permissions.destroy', ':id')); ?>';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/permissions/index.blade.php ENDPATH**/ ?>