...
<div class="container-fluid">
    <?php echo $__env->make("layouts.includes.breadcrumb", [ 'page' => 'لوحة التحكم' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php if($hasDashboardAccess): ?>
                    ...
                    <div class="card-body p-6">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                ...
                                <div class="db-metric-value text-primary"><?php echo e(number_format($stats['total_bookings'])); ?></div>
                            </div>
                        ...
                        <div class="pt-3 border-top d-flex flex-wrap gap-2 align-items-center">
                            <span class="db-pill mr-2 mb-1">
                                <i class="fas fa-sun text-warning mr-1"></i> اليوم: <strong class="ml-1 text-dark"><?php echo e($stats['today_bookings']); ?></strong>
                            </span>
                            <span class="db-pill mb-1">
                                <i class="fas fa-calendar-week text-info mr-1"></i> الأسبوع: <strong class="ml-1 text-dark"><?php echo e($stats['week_bookings']); ?></strong>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-6">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                ...
                                <div class="db-metric-value text-info"><?php echo e(number_format($stats['total_containers'])); ?></div>
                            </div>
                        ...
                        <div class="pt-3 border-top">
                            <span class="db-pill">
                                <i class="fas fa-calendar-day text-info mr-1"></i> مضافة اليوم: <strong class="ml-1 text-dark"><?php echo e($stats['today_containers']); ?></strong>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-6">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                ...
                                <div class="db-metric-value text-success"><?php echo e(number_format($stats['total_agents'])); ?></div>
                            </div>
                        ...
                        <div class="pt-3 border-top">
                            <span class="db-pill">
                                <i class="fas fa-user-shield text-success mr-1"></i> رئيسيين: <strong class="ml-1 text-dark"><?php echo e($stats['total_superagents']); ?></strong>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-6">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                ...
                                <div class="db-metric-value text-warning" style="font-size: 1.65rem;">
                                    <?php echo e(number_format($stats['vault_amount'], 2)); ?> <small class="font-size-xs">ج.م</small>
                                </div>
                            </div>
                        ...
                        <div class="pt-3 border-top">
                            <span class="db-pill">
                                ...
                                <strong class="ml-1 <?php echo e(($stats['month_income'] - $stats['month_expenses']) >= 0 ? 'text-success' : 'text-danger'); ?>">
                                    <?php echo e(number_format($stats['month_income'] - $stats['month_expenses'], 2)); ?> ج.م
                                </strong>
                            </span>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                <div class="card db-stat-card shadow-sm">
                    <div class="card-body p-5 text-center">
                        ...
                        <h3 class="font-weight-bolder text-dark mb-1"><?php echo e(number_format($stats['total_companies'])); ?></h3>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                <div class="card db-stat-card shadow-sm">
                    <div class="card-body p-5 text-center">
                        ...
                        <h3 class="font-weight-bolder text-dark mb-1"><?php echo e(number_format($stats['total_cars'])); ?></h3>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                <div class="card db-stat-card shadow-sm">
                    <div class="card-body p-5 text-center">
                        ...
                        <h3 class="font-weight-bolder text-dark mb-1"><?php echo e(number_format($stats['total_drivers'])); ?></h3>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                <div class="card db-stat-card shadow-sm">
                    <div class="card-body p-5 text-center">
                        ...
                        <h3 class="font-weight-bolder text-dark mb-1"><?php echo e(number_format($stats['total_delivery_policies'])); ?></h3>
        ...
        <div class="row mb-6">
            <div class="col-lg-<?php echo e(auth()->user()->hasPermissionTo('accounts.index') ? '6' : '12'); ?> mb-4">
                <div class="card db-stat-card shadow-sm h-100">
                    ...
                    <div class="card-body p-6">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                ...
                                <div class="db-metric-value text-danger"><?php echo e(number_format($stats['total_invoices'])); ?></div>
                            </div>
                        ...
                        <div class="pt-3 border-top d-flex gap-3">
                            <span class="db-pill mr-2">
                                <i class="fas fa-calendar-day text-danger mr-1"></i> فواتير اليوم: <strong class="ml-1 text-dark"><?php echo e($stats['today_invoices']); ?></strong>
                            </span>
                            <span class="db-pill">
                                <i class="fas fa-calendar-alt text-danger mr-1"></i> فواتير هذا الشهر: <strong class="ml-1 text-dark"><?php echo e($stats['month_invoices']); ?></strong>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mb-4">
                <a href="<?php echo e(route('accounts.checks.index')); ?>" class="text-decoration-none">
                    <div class="card db-stat-card shadow-sm h-100">
                        ...
                        <div class="card-body p-6">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    ...
                                    <div class="db-metric-value text-dark"><?php echo e(number_format($stats['checks_due_within_3_days'] ?? 0)); ?></div>
                                </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                <div class="db-financial-box expenses text-center">
                                    ...
                                    <h4 class="font-weight-bolder text-danger mb-1"><?php echo e(number_format($stats['today_expenses'], 2)); ?> <small class="font-size-xs">ج.م</small></h4>
                            ...
                            <div class="col-6">
                                <div class="db-financial-box income text-center">
                                    ...
                                    <h4 class="font-weight-bolder text-success mb-1"><?php echo e(number_format($stats['today_income'], 2)); ?> <small class="font-size-xs">ج.م</small></h4>
                                    <span class="text-muted font-weight-bold font-size-sm">الواردات</span>
                                </div>
                            </div>
                        </div>
                        <div class="p-4 rounded-xl text-center <?php echo e(($stats['today_income'] - $stats['today_expenses']) >= 0 ? 'bg-light-success text-success' : 'bg-light-danger text-danger'); ?>">
                            <span class="font-weight-bold d-block mb-1">صافي حركة اليوم</span>
                            <h4 class="font-weight-bolder mb-0">
                                <?php echo e(number_format($stats['today_income'] - $stats['today_expenses'], 2)); ?> ج.م
                            </h4>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                <div class="db-financial-box expenses text-center">
                                    ...
                                    <h4 class="font-weight-bolder text-danger mb-1"><?php echo e(number_format($stats['month_expenses'], 2)); ?> <small class="font-size-xs">ج.م</small></h4>
                                    <span class="text-muted font-weight-bold font-size-sm">المصروفات</span>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="db-financial-box income text-center">
                                    ...
                                    <h4 class="font-weight-bolder text-success mb-1"><?php echo e(number_format($stats['month_income'], 2)); ?> <small class="font-size-xs">ج.م</small></h4>
                                    <span class="text-muted font-weight-bold font-size-sm">الواردات</span>
                                </div>
                            </div>
                        </div>
                        <div class="p-4 rounded-xl text-center <?php echo e(($stats['month_income'] - $stats['month_expenses']) >= 0 ? 'bg-light-success text-success' : 'bg-light-danger text-danger'); ?>">
                ...
                <div class="db-restricted-card">
                    ...
                    <div class="border-top pt-6 mt-4">
                        ...
                        <div class="row justify-content-center">
                            <?php if($user->can('bookings.index') || ($user->hasPermissionTo('bookings.index') ?? false)): ?>
                                <div class="col-md-4 col-sm-6 mb-3">
                                    <a href="<?php echo e(route('bookings.index')); ?>" class="db-shortcut-card">
                            ...
                            <?php if($user->can('containers.index') || ($user->hasPermissionTo('containers.index') ?? false)): ?>
                                <div class="col-md-4 col-sm-6 mb-3">
                                    <a href="<?php echo e(route('containers.index')); ?>" class="db-shortcut-card">
                            ...
                            <?php if($user->can('companies.index') || ($user->hasPermissionTo('companies.index') ?? false)): ?>
                                <div class="col-md-4 col-sm-6 mb-3">
                                    <a href="<?php echo e(route('companies.index')); ?>" class="db-shortcut-card">
                            ...
                            <?php if($user->can('drivers.index') || ($user->hasPermissionTo('drivers.index') ?? false)): ?>
                                <div class="col-md-4 col-sm-6 mb-3">
                                    <a href="<?php echo e(route('drivers.index')); ?>" class="db-shortcut-card">
                            ...
                            <?php if($user->can('cars.index') || ($user->hasPermissionTo('cars.index') ?? false)): ?>
                                <div class="col-md-4 col-sm-6 mb-3">
                                    <a href="<?php echo e(route('cars.index')); ?>" class="db-shortcut-card">
                            ...
                            <?php if($user->can('permissions.index') || ($user->hasPermissionTo('permissions.index') ?? false)): ?>
                                <div class="col-md-4 col-sm-6 mb-3">
                                    <a href="<?php echo e(route('permissions.index')); ?>" class="db-shortcut-card">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (bookingsElem) {
            ...
            new Chart(bookingsCtx, {
                type: 'line',
                data: {
                    labels: <?php echo json_encode($bookingsChart['labels'], 15, 512) ?>,
                    datasets: [{
                        label: 'عدد الحجوزات',
                        data: <?php echo json_encode($bookingsChart['data'], 15, 512) ?>,
                        borderColor: '#3699FF',
        ...
        if (financialElem) {
            ...
            new Chart(financialCtx, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($financialChart['labels'], 15, 512) ?>,
                    datasets: [
                        {
                            label: 'المصروفات',
                            data: <?php echo json_encode($financialChart['expenses'], 15, 512) ?>,
                        ...
                        {
                            label: 'الواردات',
                            data: <?php echo json_encode($financialChart['income'], 15, 512) ?>,
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/index.blade.php ENDPATH**/ ?>