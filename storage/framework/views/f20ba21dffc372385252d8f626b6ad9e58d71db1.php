...
?>
<table style="display: table; width: 100%; margin-top: 0.2rem; border-spacing: 0; border: 1px solid <?php echo e($borderColor); ?>; border-radius: 4px; overflow: hidden;">
    <thead style="background: <?php echo e($theadBg); ?>; color: <?php echo e($theadColor); ?>; font-family: 'Cairo', sans-serif; font-size: 0.7rem; vertical-align: middle;">
        <tr>
            <th style="padding: 5px 8px; text-align: center; font-weight: 700; border-right: 1px solid <?php echo e($isBw ? '#000' : 'rgba(255, 255, 255, 0.1)'); ?>; width: 50px;">م</th>
            <th style="padding: 5px 8px; text-align: start; font-weight: 700; border-right: 1px solid <?php echo e($isBw ? '#000' : 'rgba(255, 255, 255, 0.1)'); ?>;"><?php echo e($tableTitle); ?></th>
    ...
    <tbody style="font-family: 'Cairo', sans-serif; font-size: 0.7rem; text-align: center; vertical-align: middle;">
        <?php if(!empty($empty_message) && (isset($items) && count($items) === 0)): ?>
            <tr>
                <td style="padding: 10px 8px; border-bottom: 1px solid <?php echo e($borderColor); ?>;">1</td>
                <td style="padding: 10px 8px; text-align: center; border-bottom: 1px solid <?php echo e($borderColor); ?>; color: #6c757d;">لا توجد بنود</td>
                <td style="padding: 10px 8px; border-bottom: 1px solid <?php echo e($borderColor); ?>;">-</td>
            </tr>
        <?php else: ?>
