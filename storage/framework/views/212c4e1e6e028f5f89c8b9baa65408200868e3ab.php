...
<div class="letterhead-header"
    ...
    ">
        ...
        ">
            ...
            <?php if($privateCompanyCommercialRegister): ?>
                <div style="font-size: 12px; color: #666; margin-bottom: 2px;">السجل التجاري: <?php echo e($privateCompanyCommercialRegister); ?></div>
            <?php endif; ?>

            <?php if($privateCompanyTaxNo): ?>
                <div style="font-size: 12px; color: #666;">ب.ض: <?php echo e($privateCompanyTaxNo); ?></div>
            <?php endif; ?>
        </div>
...
<div class="letterhead-footer" style="position: fixed; bottom: 0; left: 0; right: 0; background: #fff; border: 2px solid #8B4513; border-radius: 8px; padding: 15px 20px; z-index: 1000; display: none; margin: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    ...
    <div style="flex: 1; border-right: 1px solid #8B4513; padding-right: 20px;">
        <div style="font-size: 12px; color: #333; line-height: 1.8; font-family: Arial, sans-serif;">
            <div><strong>MOBILE:</strong> <?php echo e($contactPhone1); ?></div>
            <div><strong>MOBILE:</strong> <?php echo e($contactPhone2); ?></div>
            <div><strong>Tel-Fax:</strong> <?php echo e($contactTelFax); ?></div>
            <div><strong>E-mail:</strong> <?php echo e($contactEmail); ?></div>
        </div>
    </div>
    ...
    <div style="flex: 1; padding-left: 20px; text-align: right;">
        <div style="font-size: 13px; color: #333; line-height: 1.8; font-family: 'Cairo', sans-serif;">
            <div style="margin-bottom: 5px;">
                ...
                ?>
                <span style="color: #DC143C; font-weight: bold;"><?php echo e($firstPart); ?></span>
                <?php if($restParts): ?>
                    <span style="color: #333;"><?php echo e($restParts); ?></span>
                <?php endif; ?>
            </div>
            <div style="margin-bottom: 5px;">لنقل الحاويات</div>
            <div><?php echo e($contactAddress); ?></div>
        </div>
    </div>
</div>
...
<div style="background: linear-gradient(135deg, #DC143C 0%, #B22222 100%); padding: 8px 12px; border-radius: 6px; margin-bottom: 6px; box-shadow: 0 4px 15px rgba(220, 20, 60, 0.2); -webkit-print-color-adjust: exact; print-color-adjust: exact; color-adjust: exact; display: block !important; visibility: visible !important; page-break-inside: avoid; position: relative; z-index: 2;">
    <div style="display: flex; align-items: center; justify-content: space-between;">
        <div style="display: flex; align-items: center; gap: 8px;">
            <h2 style="font-family: 'Cairo', sans-serif; color: #fff; margin: 0; font-size: 16px; font-weight: 700;"><?php echo e(str_replace('فواتير', 'فاتوره', $document_title ?? '')); ?> - <?php echo e($clientName); ?></h2>
        </div>
        <div style="display: flex; align-items: center; gap: 12px;">
            <div style="display: flex; align-items: center; gap: 4px;">
                <?php if($attachment_print ?? false): ?>
                    <span style="color: #fff; font-weight: 600; font-size: 11px;">رقم:</span>
                    <span style="color: #fff; font-size: 12px; font-weight: 700;">R <?php echo e($invoice->invoice_number ?? ""); ?></span>
                <?php else: ?>
                    <span style="color: #fff; font-weight: 600; font-size: 11px;">فاتورة رقم:</span>
                    <span style="color: #fff; font-size: 12px; font-weight: 700;"><?php echo e($invoice->invoice_number ?? ""); ?></span>
                <?php endif; ?>
            </div>
            <div style="display: flex; align-items: center; gap: 4px;">
                <span style="color: #fff; font-weight: 600; font-size: 11px;">التاريخ:</span>
                <span style="color: #fff; font-size: 11px;"><?php echo e(optional($invoice->created_at)->format('d-m-Y')); ?></span>
            </div>
        </div>
    </div>
</div>
    ...
    <div style="background: #fff; padding: 6px 10px; border-radius: 6px; border: 1px solid #dee2e6; border-right: 3px solid #DC143C;">
        <div style="display: flex; flex-direction: column; gap: 4px;">
            <div style="display: flex; align-items: center; gap: 4px;">
                ...
                <span style="color: #212529; font-size: 11px;"><?php echo e($invoice->booking->employee?->name ?? $invoice->booking->company->name ?? ""); ?></span>
            </div>
            <?php if($clientTaxNo): ?>
            <div style="display: flex; align-items: center; gap: 4px;">
                <span style="font-weight: 700; color: #495057; font-size: 10px; min-width: 75px;">📋 الرقم الضريبي:</span>
                <span style="color: #212529; font-size: 11px;"><?php echo e($clientTaxNo); ?></span>
            </div>
            <?php endif; ?>
            <div style="display: flex; align-items: center; gap: 4px;">
                <span style="font-weight: 700; color: #495057; font-size: 10px; min-width: 75px;">🚢 الخط الملاحي:</span>
                <span style="color: #212529; font-size: 11px;"><?php echo e($invoice->booking->shippingAgent->title ?? ""); ?></span>
            </div>
        </div>
    </div>
    ...
    <div style="background: #fff; padding: 6px 10px; border-radius: 6px; border: 1px solid #dee2e6; border-right: 3px solid #28a745;">
        <div style="display: flex; flex-direction: column; gap: 4px;">
            ...
            <div style="display: flex; align-items: center; gap: 4px;">
                ...
                <span style="color: #212529; font-size: 11px;"><?php echo e($factoryName); ?></span>
            </div>
            <div style="display: flex; align-items: center; gap: 4px;">
                <span style="font-weight: 700; color: #495057; font-size: 10px; min-width: 75px;">📋 رقم الحجز:</span>
                <span style="color: #212529; font-size: 11px; font-weight: 700;"><?php echo e($invoice->booking->booking_number ?? ""); ?></span>
            </div>
            <div style="display: flex; align-items: center; gap: 4px;">
                <span style="font-weight: 700; color: #495057; font-size: 10px; min-width: 75px;">📄 رقم الشهادة:</span>
                <span style="color: #212529; font-size: 11px;"><?php echo e($invoice->booking->certificate_number ?? ""); ?></span>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/components/booking-invoices/printing/letterhead.blade.php ENDPATH**/ ?>