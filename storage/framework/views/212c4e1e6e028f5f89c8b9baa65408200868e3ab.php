            ...
            <div style="display: flex; align-items: center; gap: 4px;">
                <?php
                    ...
                    $numberLabel = ($attachment_print ?? false) || !empty($document_number_label_short)
                        ...
                        : 'فاتورة رقم:';
                ?>
                <span style="color: #fff; font-weight: 600; font-size: 11px;"><?php echo e($numberLabel); ?></span>
                <span style="color: #fff; font-size: 12px; font-weight: 700;"><?php echo e($resolvedDocumentNumber); ?></span>
            </div>
            <div style="display: flex; align-items: center; gap: 4px;">
