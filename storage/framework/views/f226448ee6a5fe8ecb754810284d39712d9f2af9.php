    ...
    <td style="padding: 4px 6px; text-align: start; border-right: 1px solid #e9ecef; vertical-align: top;">
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 4px;">
            <div style="display: flex; align-items: center; gap: 3px;">
                <?php if(!$hideLabel): ?>
                    <span style="font-weight: 700; color: #6c757d; font-size: 9px; min-width: 70px;"><?php echo e($label); ?></span>
                <?php endif; ?>
                <span style="color: #212529; font-size: 11px; font-weight: 600;"><?php echo e($displayValue); ?></span>
            </div>
            <?php if($booking_service->note): ?>
            <div style="display: flex; align-items: start; gap: 3px; background: #fff3cd; padding: 2px 4px; border-radius: 3px; border-right: 2px solid #ffc107;">
                ...
                <span style="color: #856404; font-size: 9px;"><?php echo e($booking_service->note); ?></span>
            </div>
            <?php else: ?>
            <div></div>
            <?php endif; ?>
        </div>
        <?php if($booking_service->image && $booking_service->getRawOriginal('image')): ?>
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 4px; margin-top: 2px;">
            <div style="display: flex; align-items: start; gap: 3px; background: #ffe6e6; padding: 2px 4px; border-radius: 3px; border-right: 2px solid #DC143C;">
                ...
                <a href="<?php echo e($booking_service->image); ?>" target="_blank" style="color: #DC143C; font-size: 9px; text-decoration: underline;">عرض الإيصال</a>
            </div>
            <div></div>
        </div>
        <?php endif; ?>
    </td>
    <td style="padding: 4px 6px; text-align: center; font-weight: 700; color: #28a745; font-size: 12px; background: #f8f9fa; vertical-align: top;"><?php echo e(number_format($booking_service->price ?? 0, 2)); ?> ج.م</td>
</tr>
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/components/booking-invoices/printing/table/service-row.blade.php ENDPATH**/ ?>