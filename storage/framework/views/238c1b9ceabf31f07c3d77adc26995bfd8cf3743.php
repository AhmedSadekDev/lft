...
<?php elseif($method == 'PUT'): ?>
    <?php echo Form::model($car, ['url' => [$action], 'method'=>$method , 'enctype'=>'multipart/form-data', 'files' => true]); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        <?php echo Form::label("input_name", __('admin.car_number')); ?>

                        <?php echo Form::text('car_number' , old('car_number'), ["class" => "form-control", "id" => "input_name", "placeholder"=> __('admin.car_number')]); ?>
...
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/cars/form.blade.php ENDPATH**/ ?>