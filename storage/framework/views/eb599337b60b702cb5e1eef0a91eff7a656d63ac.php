...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="stage-tabs-wrapper">
            <?php $__currentLoopData = $tabItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stageKey => $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <a href="<?php echo e(route('bookings.index', $queryParams)); ?>"
                   class="stage-tab-btn <?php echo e($isActive ? 'active' : ''); ?>">
                    <i class="<?php echo e($tab['icon']); ?>"></i>
                    <span><?php echo e($tab['label']); ?></span>
                    <span class="badge"><?php echo e($tab['count']); ?></span>
                </a>
        ...
        <div class="card filter-card mb-4">
            ...
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('bookings.index')); ?>" id="filterForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <select name="stage" class="form-control">
                                <option value="" <?php echo e(($currentStage == 'all' || empty($currentStage)) ? 'selected' : ''); ?>><?php echo e(__('admin.all')); ?></option>
                                <option value="assigned" <?php echo e($currentStage == 'assigned' ? 'selected' : ''); ?>>التخصيص (Assigned)</option>
                                <option value="waiting" <?php echo e($currentStage == 'waiting' ? 'selected' : ''); ?>>الانتظار (Waiting)</option>
                                <option value="loading" <?php echo e($currentStage == 'loading' ? 'selected' : ''); ?>>التحميل (Loading)</option>
                                <option value="unloading" <?php echo e($currentStage == 'unloading' ? 'selected' : ''); ?>>التعتيق (Unloading)</option>
                                <option value="invoiced" <?php echo e($currentStage == 'invoiced' ? 'selected' : ''); ?>>فواتير منتهية (Invoiced)</option>
                            </select>
                        </div>
                    ...
                    <!-- Active Filters -->
                    <?php if(request()->hasAny(['search', 'arrival_date', 'company', 'tax_status', 'invoice_status', 'stage', 'status'])): ?>
                        <div class="row mt-2">
                            <div class="col-12">
                                <small class="text-muted">الفلاتر النشطة:</small>
                                <?php if(request('stage') && request('stage') !== 'all'): ?>
                                    <?php
                                        $stageLabels = [
                                            'assigned' => 'التخصيص',
                                            'waiting' => 'الانتظار',
                                    ...
                                    <span class="filter-badge">
                                        المرحلة: <?php echo e($stageLabels[request('stage')] ?? request('stage')); ?>

                                        <a href="<?php echo e(route('bookings.index', request()->except(['stage', 'status']))); ?>" class="ml-2 text-danger">
                ...
                <div class="card-toolbar">
                    ...
                    <?php if($bookings->count() > 0): ?>
                        <a class="btn btn-success ml-2"
                            href="<?php echo e(route('booking_container.export', request()->only(['search', 'date_from', 'date_to', 'company', 'tax_status', 'invoice_status', 'stage']))); ?>"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php $stageInfo = $booking->stage_info; ?>
                                            <span class="badge <?php echo e($stageInfo['badge']); ?> badge-custom" style="white-space: nowrap;">
                                                <i class="<?php echo e($stageInfo['icon']); ?> mr-1"></i> <?php echo e($stageInfo['label']); ?>
