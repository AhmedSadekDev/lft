...
<?php elseif($method == 'PUT'): ?>
    <?php echo Form::model($driver, ['url' => [$action], 'method'=>$method , 'enctype'=>'multipart/form-data', 'files' => true]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <?php echo Form::number( 'phone' , old('phone'), ["class" => "form-control", "id" => "input_phone", "placeholder"=> __('admin.phone')]); ?>
...
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/drivers/form.blade.php ENDPATH**/ ?>