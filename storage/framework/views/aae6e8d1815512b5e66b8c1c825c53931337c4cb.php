...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-header text-white d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
            ...
            <div>
                <a href="<?php echo e(route('accounts.statement.export.excel', ['companyId'=>$company->id,'from'=>$fromDate,'to'=>$toDate,'mode'=>$mode ?? 'combined'])); ?>"
                   class="btn btn-light btn-sm mr-2">
                    <i class="fas fa-file-excel text-success"></i> Excel
                </a>

                <a href="<?php echo e(route('accounts.statement.export.pdf', ['companyId'=>$company->id,'from'=>$fromDate,'to'=>$toDate,'mode'=>$mode ?? 'combined'])); ?>"
                   class="btn btn-light btn-sm mr-2">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                <div class="mb-2 mb-md-0">
                    ...
                    <div class="btn-group" role="group">
                        <a href="<?php echo e(route('accounts.statement', ['companyId' => $company->id, 'from' => $fromDate, 'to' => $toDate, 'mode' => 'combined'])); ?>"
                           class="btn btn-sm <?php echo e(($mode ?? 'combined') === 'combined' ? 'btn-dark' : 'btn-outline-dark'); ?>">
                            كشف حساب مجمّع
                        </a>
                        <a href="<?php echo e(route('accounts.statement', ['companyId' => $company->id, 'from' => $fromDate, 'to' => $toDate, 'mode' => 'detailed'])); ?>"
                           class="btn btn-sm <?php echo e(($mode ?? 'combined') === 'detailed' ? 'btn-dark' : 'btn-outline-dark'); ?>">
                            كشف حساب تفصيلي
                        </a>
                    </div>
                </div>
                ...
                <strong>
                    ...
                    —
                    <?php echo e(($mode ?? 'combined') === 'detailed' ? 'تفصيلي (I / R / S)' : 'مجمّع'); ?>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(in_array($transaction['type'] ?? '', ['invoice', 'invoice_tax', 'invoice_receipt', 'invoice_additional'], true)): ?>
                                        <?php if(($transaction['type'] ?? '') === 'invoice_tax'): ?>
                                            <span class="badge badge-danger">ضريبية (I)</span>
                                        <?php elseif(($transaction['type'] ?? '') === 'invoice_receipt'): ?>
                                            <span class="badge badge-primary">إيصالات (R)</span>
                                        <?php elseif(($transaction['type'] ?? '') === 'invoice_additional'): ?>
        ...
        <div class="modal-content">
            <form method="GET" action="<?php echo e(route('accounts.statement',$company->id)); ?>">
                ...
                <div class="modal-body">
                    ...
                    <label>إلى</label>
                    <input type="date" name="to" value="<?php echo e($toDate); ?>" class="form-control mb-3">

                    <label>نوع الكشف</label>
                    <select name="mode" class="form-control">
                        <option value="combined" <?php echo e(($mode ?? 'combined') === 'combined' ? 'selected' : ''); ?>>كشف حساب مجمّع</option>
                        <option value="detailed" <?php echo e(($mode ?? 'combined') === 'detailed' ? 'selected' : ''); ?>>كشف حساب تفصيلي</option>
                    </select>
                </div>
