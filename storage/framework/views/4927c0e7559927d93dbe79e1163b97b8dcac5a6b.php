        ...
        <div class="invoice-wrapper">
            <div class="print" id="printableAreaDetailedTax"
                ...
                <div class="invoice" style="overflow: visible;">
                    ...
                    <?php echo $__env->make('admin.components.booking-invoices.printing.section-block', [
                        'group' => $taxGroup,
                        'border_color' => '#DC143C',
                ...
                <div class="invoice" style="overflow: visible;">
                    <div style="text-align: center; margin-bottom: 10px; border-bottom: 2px solid #000; padding-bottom: 8px;">
                        <div style="font-size: 13px; font-weight: 700;">
                            رقم: <?php echo e($invoice->invoice_number ?? ''); ?>-R/S
                            &nbsp;|&nbsp;
                            التاريخ: <?php echo e(optional($invoice->created_at)->format('d-m-Y')); ?>
                    ...
                    <div style="margin-top: 10px; border: 2px solid #000; padding: 10px 12px;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span style="font-weight: 700; font-size: 15px;"><?php echo e(number_format($attachmentsSubtotal, 2)); ?> ج.م</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="invoice" style="overflow: visible;">
                <div style="text-align: center; margin-bottom: 12px; border-bottom: 2px solid #000; padding-bottom: 8px;">
                    ...
                    <div style="font-size: 13px;">
                        رقم: <?php echo e($invoice->invoice_number ?? ''); ?>
                ...
                <div style="margin-top: 10px; border: 2px solid #000; padding: 10px 12px;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <span style="font-weight: 700; font-size: 16px;"><?php echo e(number_format($combinedTotal, 2)); ?> ج.م</span>
                    </div>
                </div>
            </div>
        </div>
