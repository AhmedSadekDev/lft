...
<body>
    ...
    <div class="buttons-container">
        ...
        <?php if(!$hasPayments): ?>
            <form method="POST"
                  action="<?php echo e(route('booking-invoices.destroy', ['booking_invoice' => $invoice->id])); ?>"
        ...
        <div class="invoice-wrapper">
            <div class="print" id="printableArea" style="width: 100%;margin: 0;padding: 10px 15px;border: 2px solid #DC143C; border-radius: 8px; box-shadow: 0 4px 20px rgba(220, 20, 60, 0.15); background: #fff;">
                ...
                <div class="invoice" style="overflow: visible;">
                    ...
                    <?php echo $__env->make('admin.components.booking-invoices.printing.letterhead', [
                    ...
                    <?php if(count($fpr) <= $fpr_hf_limit): ?>
                        <?php echo $__env->make('admin.components.booking-invoices.printing.invoice-totals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                ...
                <!-- Middle page(s) -->
                <?php $__empty_1 = true; $__currentLoopData = $mps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mpr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="invoice" style="overflow: visible;">
        ...
        <div class="invoice-wrapper">
            <div class="printAttachments" id="printableAreaAttachments"
                ...
                <div class="invoice" style="overflow: visible;">
                    ...
                    <div style="margin-bottom: .3rem;">
                        <?php if(isset($attachment_rows) && count($attachment_rows) > 0): ?>
                            <?php echo $__env->make('admin.components.booking-invoices.printing.table.layout', [
                    ...
                    <?php echo $__env->make('admin.components.booking-invoices.printing.attachment-invoice-summary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/bookings/booking-invoices/show.blade.php ENDPATH**/ ?>