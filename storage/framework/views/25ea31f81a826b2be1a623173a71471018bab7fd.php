        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-toolbar">
                    ...
                    <a href="<?php echo e(request()->has('role') ? route('users.create', ['role' => request()->role]) : route('users.create')); ?>" class="btn btn-primary font-weight-bolder">
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('users.edit', $user->id)); ?><?php echo e(request()->has('role') ? '?role=' . request()->role : ''); ?>"
                                            class="btn btn-icon btn-sm btn-secondary">
                                            <i class="fas fa-pen"></i>
                                        </a>

                                        <button class="btn btn-icon btn-light btn-hover-danger btn-sm delete"
                                            onclick="Delete('<?php echo e($user->id); ?>')">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/users/index.blade.php ENDPATH**/ ?>