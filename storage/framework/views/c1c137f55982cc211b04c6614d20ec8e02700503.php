        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group">
                    <?php echo Form::label("input_service_categories", __('admin.agent'), ["class" => "required-field"]); ?>

                    <?php echo Form::select('agent_id' , $agents, old('agent_id') , ["class" => "form-control selectpicker", "id" => "agents", "placeholder"=> __('admin.agent'),"data-live-search" => "true"]); ?>
...
<!-- /.card-body -->
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/financial_custody_agents/form.blade.php ENDPATH**/ ?>