...
<?php elseif($method == 'PUT'): ?>
    <?php echo Form::model($booking_service ?? null, [
        'url' => $action,
        'method' => $method,
        'enctype' => 'multipart/form-data',
    ]); ?>
    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="form-group<?php echo e($errors->has('service_type_id') ? ' has-error' : ''); ?>">
                <?php echo Form::label('service_type_id', __('admin.service_type')); ?>
                ...
                <small class="text-danger"><?php echo e($errors->first('service_type_id')); ?></small>
            </div>
        </div>

        <div class="col-md-6 col-sm-12">
            <div class="form-group<?php echo e($errors->has('service_id') ? ' has-error' : ''); ?>">
                <?php echo Form::label('service_id', __('admin.service')); ?>
                ...
                ?>
                <?php echo Form::select('service_id', $service_options, $selected_service_id, [
                    'id' => 'service_id',
                    'class' => 'form-control',
                    'required' => 'required',
                ]); ?>

                <small class="text-danger"><?php echo e($errors->first('service_id')); ?></small>
            </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group<?php echo e($errors->has('price') ? ' has-error' : ''); ?>">
                ...
                <?php echo Form::number('price', old('price'), ['class' => 'form-control', 'required' => 'required', 'step' => '0.01', 'min' => 0]); ?>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <?php echo Form::textarea('note', old('note'), [
                    'class' => 'form-control',
                    'id' => 'input_note',
                    'rows' => 2,
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group<?php echo e($errors->has('payment_type') ? ' has-error' : ''); ?>">
                <?php echo Form::label('payment_type', __('admin.payment_type')); ?>

                <?php echo Form::select('payment_type',
                    [
                ...
                <small class="text-danger"><?php echo e($errors->first('payment_type')); ?></small>
            </div>
        </div>

        <div class="col-md-12 col-sm-12" id="vault_field" style="display: none;">
            <div class="form-group">
                <small class="text-muted d-block mb-2"><?php echo e(__('admin.payment_from_vault')); ?></small>
            </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12" id="bank_field" style="display: none;">
            <div class="form-group<?php echo e($errors->has('bank_id') ? ' has-error' : ''); ?>">
                <?php echo Form::label('bank_id', __('main.bank')); ?>

                <?php echo Form::select('bank_id',
        ...
        <div class="col-md-12 col-sm-12" id="agent_field" style="display: none;">
            <div class="form-group<?php echo e($errors->has('agent_id') ? ' has-error' : ''); ?>">
                <?php echo Form::label('agent_id', __('main.agent')); ?>

                <?php echo Form::select('agent_id',
                ...
                <small class="text-danger"><?php echo e($errors->first('agent_id')); ?></small>
            </div>
        </div>
        ...
        <div class="col-md-6 col-sm-12" id="supplier_field" style="display: none;">
            <div class="form-group<?php echo e($errors->has('supplier_id') ? ' has-error' : ''); ?>">
                ...
                <small class="text-danger"><?php echo e($errors->first('supplier_id')); ?></small>
            </div>
        </div>

        <div class="col-md-6 col-sm-12" id="supplier_invoice_field" style="display: none;">
            <div class="form-group<?php echo e($errors->has('supplier_invoice_number') ? ' has-error' : ''); ?>">
                <?php echo Form::label('supplier_invoice_number', 'رقم فاتورة المورد'); ?>

                <?php echo Form::text('supplier_invoice_number',
                ...
                <small class="text-danger"><?php echo e($errors->first('supplier_invoice_number')); ?></small>
            </div>
        </div>

        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                <?php echo Form::label('input_note', __('admin.receipt_image')); ?>

                <input type="file" accept="image/*" name="image" id="input_receipt_image" class="form-control">
                <?php if(isset($booking_service) && $booking_service->image && $booking_service->getRawOriginal('image')): ?>
                    <div class="mt-3">
                        <small class="text-muted d-block mb-2"><?php echo e(__('admin.current_image')); ?>:</small>
                        <a href="<?php echo e($booking_service->image); ?>" target="_blank" style="display: inline-block;">
                            <img src="<?php echo e($booking_service->image); ?>" alt="Current Receipt"
...
<?php $__env->startPush('js'); ?>
    <script>
        <?php if(isset($booking_service) && $booking_service->service_id): ?>
            ...
            $(document).ready(function() {
                ...
                if (service_type_id && service_type_id !== 'to_be_disabled') {
                    loadServices(service_type_id, <?php echo e($booking_service->service_id); ?>);
                }
            });
        <?php endif; ?>
        ...
        function loadServices(service_type_id, selected_service_id = null) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    $('#service_id').empty();
                    $('#service_id').append(
                        `<option value="to_be_disabled"><?php echo e(__('admin.choose_service')); ?></option>`
                    );
    ...
    <script>
        var company_prices = <?php echo json_encode($company_prices); ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/components/booking-services/form.blade.php ENDPATH**/ ?>