...
<?php echo Form::model($agentExpense, [
    'url' => $action,
    'method' => $method,
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group<?php echo e($errors->has('value') ? ' has-error' : ''); ?>">
                <?php echo Form::label('value', __('admin.price')); ?>

                <?php echo Form::number('value', old('value', $agentExpense->value), [
                    'class' => 'form-control',
                    'required' => 'required',
                    'step' => '0.01',
                    'min' => 0,
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                <?php echo Form::label('notes', __('admin.note')); ?>

                <?php echo Form::textarea('notes', old('notes', $agentExpense->notes), [
                    'class' => 'form-control',
                    'id' => 'input_notes',
                    'rows' => 2,
                ...
                <small class="text-danger"><?php echo e($errors->first('notes')); ?></small>
            </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                ...
                ?>
                <?php if(filled($receiptFile)): ?>
                    <div class="mt-3">
                        <small class="text-muted d-block mb-2"><?php echo e(__('admin.current_image')); ?>:</small>
                        <a href="<?php echo e(asset('Admin/images/expenses/' . $receiptFile)); ?>" target="_blank" rel="noopener" style="display: inline-block;">
                            <img src="<?php echo e(asset('Admin/images/expenses/' . $receiptFile)); ?>" alt="Current Receipt"
...
<?php $__env->startPush('js'); ?>
    <script>
        <?php if($agentExpense->service_id): ?>
            $(document).ready(function() {
                var service_type_id = $('#service_type_id').val();
                if (service_type_id && service_type_id !== 'to_be_disabled') {
                    loadServices(service_type_id, <?php echo e($agentExpense->service_id); ?>);
                }
            });
        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home3/cloudtal/cloudymenue.cloudy-digital.com/resources/views/admin/components/booking-agent-expenses/form.blade.php ENDPATH**/ ?>